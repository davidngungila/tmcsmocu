...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Record Offering (Sadaka)</h1>
            <p class="text-gray-600 mt-1 text-sm sm:text-base">Record offering contribution from parishioner</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('finance.sadaka.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="flex justify-end space-x-4 pt-4">
                <a href="{{ route('finance.sadaka.index') }}" 
