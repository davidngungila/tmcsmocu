...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Create Apostolic Group</h1>
            <p class="text-gray-600 mt-1 text-sm sm:text-base">Add a new apostolic group</p>
        </div>
        <a href="{{ route('apostolic-groups.index') }}" class="text-gray-600 hover:text-gray-800">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('apostolic-groups.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="border-t border-gray-200 pt-6 flex items-center justify-end space-x-4">
                <a href="{{ route('apostolic-groups.index') }}" 
