...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1 text-sm sm:text-base">Update user information</p>
        </div>
        <a href="{{ route('settings.users.show', $user->id) }}" class="text-gray-600 hover:text-gray-800">
