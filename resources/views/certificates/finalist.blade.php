...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Generate Finalist Certificates</h1>
            <p class="text-gray-600 mt-1 text-sm sm:text-base">Select parishioners and generate certificates in bulk</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h2 class="text-lg font-semibold text-gray-800 mb-4">Select Parishioners</h2>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h2 class="text-lg font-semibold text-gray-800 mb-4">Certificate Settings</h2>
        
        <form action="{{ route('certificates.finalist.store') }}" method="POST" id="certificateForm">
            @csrf
            
            <!-- Selected Recipients (Hidden) -->
            ...
            <div class="mb-6">
                ...
                <select name="template_name" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                    ...
                    <option value="standard_finalist">Standard Finalist Certificate</option>
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="3" 
                          placeholder="e.g., For outstanding achievement in the 2026 Catholic Youth Competition"
