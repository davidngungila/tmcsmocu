...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Create Community</h1>
            <p class="text-gray-600 mt-1 text-sm sm:text-base">Add a new community</p>
        </div>
        <a href="{{ route('communities.index') }}" class="text-gray-600 hover:text-gray-800">
