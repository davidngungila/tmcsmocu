        ...
        <nav class="flex-1 overflow-y-auto py-3">
            ...
            <div>
                ...
                <div id="administration-submenu" class="hidden mt-1 ml-7 space-y-0.5">
                    ...
                    <a href="{{ route('shop.pos.receipt', ['sale' => 'recent']) }}" class="flex items-center px-3 py-1.5 text-sm text-gray-400 rounded-md hover:bg-gray-800 hover:text-white">
                        <svg class="w-4 h-4 mr-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        Receipts
                    </a>
                    <a href="{{ route('shop.inventory.create') }}" class="flex items-center px-3 py-1.5 text-sm text-gray-400 rounded-md hover:bg-gray-800 hover:text-white">
                        <svg class="w-4 h-4 mr-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        Issue Receipt
                    </a>
                    <a href="{{ route('shop.reports.index') }}" class="flex items-center px-3 py-1.5 text-sm text-gray-400 rounded-md hover:bg-gray-800 hover:text-white">
                        <svg class="w-4 h-4 mr-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        Manage Expenses
                    </a>
                    <a href="{{ route('shop.inventory.index') }}" class="flex items-center px-3 py-1.5 text-sm text-gray-400 rounded-md hover:bg-gray-800 hover:text-white">
                        <svg class="w-4 h-4 mr-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 4L13 4m0 0l-4 4a5 5 0 01-9.9 0A4 4 0 017 16m0 0C0 1.657 3.583 3 4.003 5.417.417.417 0 00-.417-.417m-6 0v4m0 0h6v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 0112 0v1zm0 0V5a2 2 0 012-2H6a2 2 0 00-2 2v14a2 2 0 002 2h2a2 2 0 002-2z"></path>
                        </svg>
                        Bulk Import
