...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Create SMS Template</h1>
            <p class="text-gray-600 mt-1 text-sm sm:text-base">Add a new SMS message template</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('sms.templates.store') }}" class="space-y-6">
            @csrf
