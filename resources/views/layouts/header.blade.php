    ...
    <div class="flex items-center space-x-4">
        ...
        <div class="hidden md:flex items-center min-w-0">
            <div class="relative min-w-0">
                <input type="text" placeholder="Search (Ctrl+K)" class="pl-10 pr-4 py-2 text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent w-56 lg:w-64">
