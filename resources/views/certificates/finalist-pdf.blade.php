...
<body>
    <div class="certificate-container">
        ...
        <div class="certificate-body">
            ...
            <p>has successfully completed the requirements for the <strong>{{ $certificate->type === 'finalist' ? 'Bachelor of Business and Information Communication Technology (BBICT)' : 'Group Participation' }}</strong></p>
